    ...
    `}>
      <div className="absolute -top-3 left-1/2 -translate-x-1/2 z-20">
        <div className="relative">
            ...
            <div className="relative w-6 h-6 bg-red-500 rounded-full border-2 border-black shadow-[inset_3px_3px_0px_rgba(255,255,255,0.3),inset_-2px_-2px_0px_rgba(0,0,0,0.1)]">
